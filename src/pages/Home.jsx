...
const Home = () => {
  ...
  return (
    <div>
      ...
      <Box sx={{ backgroundColor: 'white', width: "100vw", minHeight: isSmallDevice ? "100vh" : 'auto', display: 'flex',justifyContent:isSmallDevice?"space-between":"normal", flexDirection: isSmallDevice ? "column" : "row" }} ref={homeRef}>
